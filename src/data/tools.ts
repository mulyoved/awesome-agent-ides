...
export const tools: Tool[] = [
...

  {
    ...
    platforms: ["macos"],
    license: "agpl3",
    pricing: { toolCost: "free", aiAccess: ["none"] },
    status: "active",
...

  {
    ...
    platforms: ["macos", "linux", "windows"],
    license: "proprietary",
    pricing: { toolCost: "freemium", aiAccess: ["bundled"], details: "Free tier, Pro $18/month" },
    status: "active",
    lastVerified: "2026-03-30",
...

  {
    ...
    platforms: ["macos", "linux", "windows"],
    license: "proprietary",
    pricing: { toolCost: "freemium", aiAccess: ["bundled"], startingPrice: "$20/month", details: "Free tier, Pro $20/month, Business $40/month" },
    status: "active",
    lastVerified: "2026-03-30",
...

  {
    ...
    platforms: ["macos", "linux", "windows"],
    license: "proprietary",
    pricing: { toolCost: "freemium", aiAccess: ["bundled"], startingPrice: "$15/month" },
    status: "acquired",
    lastVerified: "2026-03-30",
    features: {
      builtInTerminal: true,
...

  {
    ...
    platforms: ["macos", "linux"],
    license: "other",
    pricing: { toolCost: "freemium", aiAccess: ["bundled", "api-key"], details: "Free editor, Zed AI add-on. Also supports BYOK." },
    status: "active",
    lastVerified: "2026-03-30",
    features: {
      builtInTerminal: true,
...

  {
    ...
    platforms: ["macos", "linux", "windows"],
    license: "proprietary",
    pricing: { toolCost: "freemium", aiAccess: ["bundled"] },
    status: "active",
    lastVerified: "2026-03-30",
    features: {
      builtInTerminal: true,
...

  {
    ...
    platforms: ["macos", "linux", "windows"],
    license: "proprietary",
    pricing: { toolCost: "free", aiAccess: ["oauth", "api-key"], details: "Included with Claude Pro/Max/Team plans. Also supports API key." },
    status: "active",
    lastVerified: "2026-03-30",
    aiModels: ["claude"],
    features: {
...

  {
    ...
    platforms: ["macos", "linux"],
    license: "mit",
    pricing: { toolCost: "free", aiAccess: ["oauth", "api-key", "free-tier"], details: "OpenAI OAuth login with free tier. Also supports API key." },
    status: "active",
    lastVerified: "2026-03-30",
    aiModels: ["codex"],
    features: {
...

  {
    ...
    platforms: ["macos", "linux", "windows"],
    license: "apache2",
    pricing: { toolCost: "free", aiAccess: ["oauth", "api-key", "free-tier"], details: "Google auth with generous free tier. Also supports API key." },
    status: "active",
    lastVerified: "2026-03-30",
    aiModels: ["gemini"],
    features: {
...

  {
    ...
    platforms: ["macos", "linux"],
    license: "mit",
    pricing: { toolCost: "free", aiAccess: ["api-key"] },
    status: "active",
    lastVerified: "2026-03-30",
    aiModels: ["any"],
    features: {
...

  {
    ...
    platforms: ["macos", "linux", "windows"],
    license: "apache2",
    pricing: { toolCost: "free", aiAccess: ["api-key", "free-tier"], details: "BYOK any provider. Free via OpenRouter free tier." },
    status: "active",
    lastVerified: "2026-03-30",
    aiModels: ["any"],
    features: {
...

  {
    ...
    license: "proprietary",
    pricing: { toolCost: "freemium", aiAccess: ["bundled"], details: "Free tier, Pro plans available" },
    status: "active",
    lastVerified: "2026-03-30",
...

  {
    ...
    platforms: ["macos", "linux", "windows"],
    license: "proprietary",
    pricing: { toolCost: "freemium", aiAccess: ["bundled"], startingPrice: "$10/month", details: "Free tier, Individual $10/mo, Business $19/mo" },
    status: "active",
    lastVerified: "2026-03-30",
...

  {
    ...
    platforms: ["macos", "linux", "windows"],
    license: "apache2",
    pricing: { toolCost: "free", aiAccess: ["oauth", "api-key"] },
    status: "active",
    lastVerified: "2026-03-30",
    aiModels: ["any"],
    features: {
...

  {
    ...
    platforms: ["web"],
    license: "proprietary",
    pricing: { toolCost: "paid", aiAccess: ["bundled"], startingPrice: "$500/month", details: "Team plans, usage-based" },
    status: "active",
    lastVerified: "2026-03-30",
...

  {
    ...
    platforms: ["web"],
    license: "proprietary",
    pricing: { toolCost: "freemium", aiAccess: ["bundled"], details: "Free tier, Core $20/mo, Teams $40/mo" },
    status: "active",
    lastVerified: "2026-03-30",
    features: {
      builtInTerminal: true,
...

  {
    ...
    platforms: ["web"],
    license: "proprietary",
    pricing: { toolCost: "freemium", aiAccess: ["bundled"], startingPrice: "$20/month" },
    status: "active",
    lastVerified: "2026-03-30",
    features: {
      builtInBrowser: true,
...

  {
    ...
    platforms: ["web"],
    license: "proprietary",
    pricing: { toolCost: "paid", aiAccess: ["bundled"], details: "Enterprise pricing" },
    status: "active",
    lastVerified: "2026-03-30",
